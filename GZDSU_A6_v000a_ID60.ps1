...
function Invoke-ExtremelyElegantFix_version2 {
    ...
    Add-Content -Path $zscriptPath -Value "// ZZ_automation_recognition_token___KEEP_THIS___--___DO_NOT_DELETE___"
    Add-Content -Path $zscriptPath -Value "`n// Auto-generated by $($script:full_title) at $currentDate"
...
Run Remove-ZscriptContentAboveKillToken ~~before~~ Invoke-ExtremelyElegantFix_version2
...
function Remove-ZscriptContentAboveKillToken {
    ...
    $tokenIndex = $existingContent.IndexOf("// ZZ_automation_recognition_token___NUKE_THIS_UP")
